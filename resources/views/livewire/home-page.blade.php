<div>
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">Start
                        your journey with <span class="text-blue-600">ShopEase</span></h1>
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="h-4 w-4 text-gray-800" width="51" height="51" viewBox="0 0 51 51"
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-gray-800 " width="80" height="27"
                        ...
                        <div class="py-5">
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-gray-800 " width="110" height="28"
    ...
    <section class="py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500 dark:text-gray-200">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach ($brands as $brand)
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire::key="{{$brand->id}}">
                        <a wire:navigate href="/products?selected_brands[0]={{$brand->id}}" class="p-5 block">
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold"> Browse <span class="text-blue-500"> Categoriess
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
                    ...
                    <a wire:navigate class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="ps-3">
                                    <svg class="flex-shrink-0 w-5 h-5 dark:text-gray-100" xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    {{-- Customer Review Sectiion Start --}}
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    Adren Roy</h2>
                                <p class="text-xs text-gray-500 dark:text-gray-300">Web Designer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-300"> Joined 12, SEP , 2022
                        </p>
                    </div>
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-300">
                    ...
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            ...
                            <h2 class="text-sm text-gray-500 dark:text-gray-300">Rating:<span
                                    class="font-semibold text-gray-600 dark:text-gray-300">
                                    3.0</span>
                            </h2>
                        </div>
                        <div
                            class="flex items-center px-6 space-x-1 text-sm font-medium text-gray-500 dark:text-gray-300">
                            <div class="flex items-center">
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    Sonira Roy</h2>
                                <p class="text-xs text-gray-500 dark:text-gray-300">Manager</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-300"> Joined 12, SEP , 2022
                        </p>
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    William harry</h2>
                                <p class="text-xs text-gray-500 dark:text-gray-300">Marketing Officer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-300"> Joined 12, SEP , 2022
                        </p>
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    James jack</h2>
                                <p class="text-xs text-gray-500 dark:text-gray-300">Java Programmer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-300"> Joined 12, SEP , 2022
                        </p>
