            ...
            <div class="px-3 mb-4">
              <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-700 ">
                <div class="flex items-center justify-between">
                  <select wire:model.live="sort"  class="block w-40 text-base bg-gray-100 cursor-pointer dark:text-gray-300 dark:bg-gray-900">
                  ...
                  @foreach ($products as $product)
                    ...
                    <div class="border border-gray-300 dark:border-gray-700">
                      ...
                      <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                        ...
                        <a wire:click.prevent="addToCart({{$product->id}})" wire:navigate href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-300">
